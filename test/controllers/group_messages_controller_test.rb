...
class GroupMessagesControllerTest < ActionController::TestCase
  ...
  test "should create group_message" do
    assert_difference('GroupMessage.count') do
      post :create, group_message: { content: @group_message.content, group_id: @group_message.group_id, title: @group_message.title }
    end
  ...
  test "should update group_message" do
    patch :update, id: @group_message, group_message: { content: @group_message.content, group_id: @group_message.group_id, title: @group_message.title }
    assert_redirected_to group_message_path(assigns(:group_message))
  end

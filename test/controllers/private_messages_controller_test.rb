...
class PrivateMessagesControllerTest < ActionController::TestCase
  ...
  test "should create private_message" do
    assert_difference('PrivateMessage.count') do
      post :create, private_message: { content: @private_message.content, to: @private_message.to, user_id: @private_message.user_id }
    end
  ...
  test "should update private_message" do
    patch :update, id: @private_message, private_message: { content: @private_message.content, to: @private_message.to, user_id: @private_message.user_id }
    assert_redirected_to private_message_path(assigns(:private_message))
  end
